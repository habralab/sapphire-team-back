...
from sapphire.storage.api.rest.specializations.schemas import SpecializationFiltersRequest
...
async def get_specializations(
    ...
    async with database_service.transaction() as session:
        paginated_specializations = await database_service.get_specializations(
            session=session, page=page, per_page=per_page, query_data=filters.query_text,
        )
