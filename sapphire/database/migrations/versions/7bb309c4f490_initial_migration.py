...
Revision ID: 7bb309c4f490
Revises: 
Create Date: 2024-02-28 12:40:02.318540
...
def upgrade() -> None:
    ...
    op.create_index('projects__owner_id_idx', 'projects', ['owner_id'], unique=False, postgresql_using='hash')
    ...
    op.create_index('positions__project_id_idx', 'positions', ['project_id'], unique=False, postgresql_using='hash')
    ...
    op.create_index('projects_history__project_id_idx', 'projects_history', ['project_id'], unique=False, postgresql_using='hash')
    ...
    op.create_index('reviews__from_user_id_idx', 'reviews', ['from_user_id'], unique=False, postgresql_using='hash')
    op.create_index('reviews__project_id_idx', 'reviews', ['project_id'], unique=False, postgresql_using='hash')
    op.create_index('reviews__to_user_id_idx', 'reviews', ['to_user_id'], unique=False, postgresql_using='hash')
    ...
    op.create_index('participants__position_id_idx', 'participants', ['position_id'], unique=False, postgresql_using='hash')
    op.create_index('participants__user_id_idx', 'participants', ['user_id'], unique=False, postgresql_using='hash')
    ...
    op.create_index('positions_skills__created_at_idx', 'positions_skills', ['created_at'], unique=False, postgresql_using='btree')
    op.create_index('positions_skills__position_id_idx', 'positions_skills', ['position_id'], unique=False, postgresql_using='hash')
    op.create_index('positions_skills__skill_id_idx', 'positions_skills', ['skill_id'], unique=False, postgresql_using='hash')
    # ### end Alembic commands ###


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index('positions_skills__skill_id_idx', table_name='positions_skills', postgresql_using='hash')
    op.drop_index('positions_skills__position_id_idx', table_name='positions_skills', postgresql_using='hash')
    op.drop_index('positions_skills__created_at_idx', table_name='positions_skills', postgresql_using='btree')
    op.drop_table('positions_skills')
    op.drop_index('participants__user_id_idx', table_name='participants', postgresql_using='hash')
    op.drop_index('participants__position_id_idx', table_name='participants', postgresql_using='hash')
    ...
    op.drop_index('projects_history__project_id_idx', table_name='projects_history', postgresql_using='hash')
    op.drop_table('projects_history')
    op.drop_table('profiles')
    op.drop_index('positions__specialization_id_idx', table_name='positions', postgresql_using='hash')
