...
class TestProjectFlow:
    ...
    @pytest.mark.asyncio
    async def test_create_project_position(self, oleg_projects_rest_client: ProjectsRestClient):
    ...
    @pytest.mark.dependency(depends=["TestProjectFlow::test_create_project_position"])
    @pytest.mark.asyncio
    async def test_create_request_to_join_project_position(
            self,
            matvey_id: uuid.UUID,
    ...
    @pytest.mark.dependency(depends=[
        "TestProjectFlow::test_create_request_to_join_project_position",
    ])
    @pytest.mark.asyncio
    @backoff.on_exception(backoff.constant, Exception, max_time=600)
    async def test_waiting_notification_about_request_to_join_project_position(
            self,
    ):
        pass
        # raise Exception
    ...
    @pytest.mark.asyncio
    async def test_waiting_email_about_request_to_join_project_position(
            self,
    ):
        pass
        # raise Exception
